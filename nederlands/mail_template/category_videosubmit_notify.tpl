...
Een nieuwe video "{VIDEO_NAME}" is ingezonden in de categorie "{CATEGORY_NAME}" op {X_SITENAME} en wacht op goedkeuring.

U kunt de ingezonden video bekijken via de onderstaande link (NB: deze pagina toont alle wachtende videos in alle categoriën):
