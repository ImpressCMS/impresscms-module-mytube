...
define( "_AM_XTUBE_DISABLEHTML", " Desarmar tags HTML" );
define( "_AM_XTUBE_DISABLESMILEY", " Desarmar Ícones Smilie" );
define( "_AM_XTUBE_DISABLEXCODE", " Desarmar XOOPS" );
define( "_AM_XTUBE_DISABLEIMAGES", " Disable Images" );
define( "_AM_XTUBE_DISABLEBREAK", " Usar conversão de quebra de linha Xoops?" );
...
define( "_AM_XTUBE_PERM_CPERMISSIONS", "Permissões às Categorias" );
...
define( "_AM_XTUBE_VIDEO_PICURLNOTE", "<small>Picture url when source is Google Video, MySpace TV, DailyMotion, Blip.tv, ClipFish or LiveLeak</small>" );
define( "_AM_XTUBE_VIDEO_DESCRIPTION", "Decrição do Vídeo: " );
...
define( "_AM_XTUBE_VIDEO_DELEDITMESS", "Excluir relato de vídeo com problemast?<br /><br /><span style='font-weight: normal;'>Quando você escolhe <b>SIM</b> o Relato de Problemas será automaticamente excluído e você confirma que o vídeo agora voltou a funcionar.</span>" );
