...
define( "_MD_XTUBE_SUBMITDATE", "Eingetragen" );
define( "_MD_XTUBE_VIDEOHITS", "<b>Aufrufe:</b> %s mal" );
define( "_MD_XTUBE_PUBLISHERC", "Einsender: " );
define( "_MD_XTUBE_RATINGC", "Wertung: " );
...
define( "_MD_XTUBE_BEFORESUBMIT", "Bevor sie ein defektes Video melden vergewisserns Sie sich, dass das Video wirklich nicht mehr angezeigt wird." );
define( "_MD_XTUBE_TELLAFRIEND", "Empfehlen" );
define( "_MD_XTUBE_EDIT", "Bearbeiten" );
define( "_MD_XTUBE_THEREARE", "Es sind <b>%s</b> <i>Kategorien</i> und <b>%s</b> <i>Videos</i> gelisted" );
define( "_MD_XTUBE_THEREIS", "Es sind <b>%s</b> <i>Kategorien</i> und <b>%s</b> <i>Videos</i> gelisted" );
define( "_MD_XTUBE_LATESTLIST", "Neuste Videos" );
...
define( "_MD_XTUBE_VIDEO_PICURLNOTE", "<small>Bild wenn das Ziel Google Video, MySpace TV, DailyMotion, Blip.tv, ClipFish, LiveLeak, Veoh, Vimeo, Viddler oder Maktoob ist.</small>" );
...
define( "_MD_XTUBE_VIDEO_PUBLISHER", "Video ersteller Name:" );
define( "_MD_XTUBE_HOMEPAGEC", "Home Page: " );
define( "_MD_XTUBE_NOTSPECIFIED", "nicht angegeben" );
define( "_MD_XTUBE_PUBLISHER", "Herausgeber" );
define( "_MD_XTUBE_UPDATEDON", "Aktualisiert am" );
...
define( "_MD_XTUBE_RATING", "Wertung" );
define( "_MD_XTUBE_VOTE", "Stimmen" );
...
define( "_MD_XTUBE_1WEEK", "1 Woche" );
define( "_MD_XTUBE_2WEEKS", "2 Wochen" );
define( "_MD_XTUBE_30DAYS", "30 Tage" );
define( "_MD_XTUBE_SHOW", "Zeige" );
...
define( "_MD_XTUBE_DUPLOADSCRSHOT", "Screenshot hochladen:" );
define( "_MD_XTUBE_RESOURCEID", "Resource id#: " );
define( "_MD_XTUBE_REPORTER", "Melder: " );
define( "_MD_XTUBE_DATEREPORTED", "Datum der Meldung: " );
define( "_MD_XTUBE_RESOURCEREPORTED", "Video als defekt gemeldet" );
...
define( "_MD_XTUBE_OTHERBYUID", "Andere Videos von: " );
define( "_MD_XTUBE_NOOTHERBYUID", "Keine anderen Videos von: " );
define( "_MD_XTUBE_LINKTIMES", "video Times: " );
define( "_MD_XTUBE_MAINTOTAL", "Gesamt Videos: " );
define( "_MD_XTUBE_VIDEONOW", "Zeige Video" );
define( "_MD_XTUBE_PAGES", "<b>Seiten</b>" );
define( "_MD_XTUBE_RATEDRESOURCE", "Bewertete Videos" );
define( "_MD_XTUBE_SUBMITTER", "Einsender" );
define( "_MD_XTUBE_ERROR", "Fehler: Information wurden nicht gespeichert" );
define( "_MD_XTUBE_COPYRIGHT", "Copyright" );
define( "_MD_XTUBE_INFORUM", "Diskutiere im Forum" );
// added frankblack
define( "_MD_XTUBE_NOTALLOWESTOSUBMIT", "Sie haben keine Bewrechtigung Videos einzusenden" );
define( "_MD_XTUBE_INFONOSAVEDB", "Information wurden nicht gespeichert: <br /><br />" );

define( "_MD_XTUBE_NEWLAST", "Neu eingeschickt diese Woche" );
define( "_MD_XTUBE_NEWTHIS", "Neu eingeschickt in dieser Woche" );
define( "_MD_XTUBE_THREE", "Neu eingeschickt in den letzten 3 Tagen" );
...
define( "_MD_XTUBE_APPROVE", "Freigegeben" );
define( "_MD_XTUBE_MODERATOR_OPTIONS", "Moderator Optionen" );
