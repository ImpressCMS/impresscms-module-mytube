...
define( "_MD_XTUBE_NOVIDEO", "این ویدئو وجود ندارد" );
define( "_MD_XTUBE_SUBCATLISTING", "فهرست شاخه‌ای" );
define( "_MD_XTUBE_ISADMINNOTICE", "مدیر: این تصویر ایراد دارد." );
define( "_MD_XTUBE_THANKSFORINFO", "از ویدئوی ارسالیتان متشکریم.<br />به محض اینکه این ویدئو توسط مدیران سایت تایید شد، به شما اطلاع می دهیم." );
define( "_MD_XTUBE_ISAPPROVED", "از ویدئوی ارسالیتان متشکریم.<br />ویدئویتان تایید شده و هم‌اکنون به فهرست ویدئوهای سایت اضافه شده است." );
...
define( "_MD_XTUBE_DESCRIPTION", "توضیحات" );
define( "_MD_XTUBE_SUBMITCATHEAD", "فرم ارسال ویدئو" );
define( "_MD_XTUBE_MAIN", "خانه" );
define( "_MD_XTUBE_POPULAR", "محبوب" );
define( "_MD_XTUBE_NEWTHISWEEK", "آخرین ویدئوهای این هفته" );
define( "_MD_XTUBE_UPTHISWEEK", "ویدئوهای بازبینی شده در این هفته" );
define( "_MD_XTUBE_POPULARITYLTOM", "محبوبیت (کمترین به بیشترین)" );
define( "_MD_XTUBE_POPULARITYMTOL", "محبوبیت (بیشترین به کمترین)" );
define( "_MD_XTUBE_TITLEATOZ", "عنوان (A به Z)" );
define( "_MD_XTUBE_TITLEZTOA", "زمانی (قدیمی‌ترها اول نشان داده شوند)" );
define( "_MD_XTUBE_DATENEW", "زمانی (جدید‌ترها اول نشان داده شوند)" );
define( "_MD_XTUBE_RATINGLTOH", "امتیازی (اول ویدوئهای با امتیاز کمتر نشان داده شوند)" );
define( "_MD_XTUBE_RATINGHTOL", "امتیازی (اول ویدوئهای با امتیاز بیشتر نشان داده شوند)" );
define( "_MD_XTUBE_DESCRIPTIONC", "اطلاعات: " );
define( "_MD_XTUBE_CATEGORYC", "شاخه: " );
define( "_MD_XTUBE_VERSION", "نسخه" );
define( "_MD_XTUBE_SUBMITDATE", "در تاریخ" );
define( "_MD_XTUBE_VIDEOHITS", "<b>%s بار دیده شده است</b>" );
define( "_MD_XTUBE_PUBLISHERC", "فرستنده: " );
define( "_MD_XTUBE_RATINGC", "امتیاز: " );
define( "_MD_XTUBE_ONEVOTE", "۱ رای" );
define( "_MD_XTUBE_NUMVOTES", "%s رای" );
define( "_MD_XTUBE_RATETHISFILE", "به این ویدئوی امتیاز دهید" );
define( "_MD_XTUBE_MODIFY", "ویرایش" );
define( "_MD_XTUBE_REPORTBROKEN", "Report Broken" );
define( "_MD_XTUBE_BROKENREPORT", "Report Broken Video" );
define( "_MD_XTUBE_SUBMITBROKEN", "ارسال" );
...
define( "_MD_XTUBE_TELLAFRIEND", "پیشنهاد کنید" );
define( "_MD_XTUBE_EDIT", "ویرایش" );
...
define( "_MD_XTUBE_LATESTLIST", "آخرین فهرست" );
define( "_MD_XTUBE_FILETITLE", "عنوان ویدئو: " );
...
define( "_MD_XTUBE_VIDEO_PICURLNOTE", "<small>Picture url when source is Google Video, MySpace TV, DailyMotion, Blip.tv, ClipFish, LiveLeak, Veoh or Maktoob</small>" );
...
define( "_MD_XTUBE_LINKID", "ش.ش ویدئو" );
