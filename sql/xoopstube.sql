...
CREATE TABLE `xoopstube_altcat` (
  ...
  PRIMARY KEY  (`lid`,`cid`)
) TYPE=MyISAM COMMENT='MyTube by McDonald' ;
...
CREATE TABLE `xoopstube_broken` (
  ...
  KEY `sender` (`sender`),
  KEY `ip` (`ip`)
) TYPE=MyISAM COMMENT='MyTube by McDonald' AUTO_INCREMENT=1 ;
...
CREATE TABLE `xoopstube_mod` (
  ...
  `vidsource` tinyint(1) unsigned NOT NULL default '0',
