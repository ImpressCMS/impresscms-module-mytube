...
function mytube_videolistheader( $heading ) {
    echo '
		<h4 style="font-weight: bold; color: #0A3760;">' . $heading . '</h4>
		<table width="100%" cellspacing="1" class="outer" summary>
		<tr>
			<th style="text-align: center; font-size: smaller;">' . _AM_MYTUBE_MINDEX_ID . '</th>
			<th style=" font-size: smaller;"><b>' . _AM_MYTUBE_MINDEX_TITLE . '</th>
			<th style="text-align: center; font-size: smaller;">' . _AM_MYTUBE_VIDSOURCE2 . '</th>
			<th style="text-align: center; font-size: smaller;">' . _AM_MYTUBE_CATTITLE . '</th>
			<th style="text-align: center; font-size: smaller;">' . _AM_MYTUBE_MINDEX_POSTER . '</th>
			<th style="text-align: center; font-size: smaller;">' . _AM_MYTUBE_MINDEX_PUBLISH . '</th>
			<th style="text-align: center; font-size: smaller;">' . _AM_MYTUBE_MINDEX_EXPIRE . '</th>
			<th style="text-align: center; font-size: smaller;">' . _AM_MYTUBE_MINDEX_ONLINE . '</th>
			<th style="text-align: center; font-size: smaller;">' . _AM_MYTUBE_MINDEX_ACTION . '</th>
		</tr>
		';
} 
...
function mytube_videolistpagenav( $pubrowamount, $start, $art = 'art', $_this = '', $align ) {
    ...
    echo '<div style="text-align: ' . $align . ';">' . $pagenav -> renderNav() . '</div>';
}
...
function mytube_getbanner_from_id_banner( $banner_id ) {
...
function mytube_getbanner_from_id_client( $client_id ) {
###### Hack by www.stefanosilvestrini.com ######
global $icmsConfig;
$db =& Database::getInstance();
