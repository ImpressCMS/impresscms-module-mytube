...
define( '_AM_MYTUBE_MINDEX_PAGEINFOTXT', '<ul><li>MyTubes main page details.</li><li>You can easily change the image logo, heading, main index header and footer text to suit your own look</li></ul><br />Note: The Logo image choosen will be used throughout MyTube.' );
...
define( "_AM_MYTUBE_MOD_HOMEPAGETITLE", "Home Page Title: " );
define( "_AM_MYTUBE_MOD_SHOTIMAGE", "Screenshot Image: " );
...
define( "_AM_MYTUBE_VIDEO_IP", "Uploaders IP Address: " );
...
define( "_AM_MYTUBE_VIDEO_PICURLNOTE", "Picture url when source is: Google Video, MySpace TV, DailyMotion, Blip.tv, ClipFish, LiveLeak, Veoh, Vimeo, Megavideo, Viddler, Maktoob or National Geographic." );
...
define( "_AM_MYTUBE_ALTCAT_INFOTEXT", "<ul><li>Alternate categories can be added or removed easily via this form.</li></ul>" );
