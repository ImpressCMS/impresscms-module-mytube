...
define("_MI_XTUBE_DESC","Laat YouTube videos zien op je website.");
...
define('_MI_XTUBE_DATEFORMATDSC', 'Standaard datumweergave voor MyTube:');
...
define('_MI_XTUBE_VIDEOIMGDIRDSC', 'Stel de map in voor MyTube video screenshots');
define('_MI_XTUBE_FLVPLAYER_CREDITS', 'FLV Speler');
define('_MI_XTUBE_FLVPLAYER_CREDITDSC', 'JW FLV Media Player door Jeroen Wijering');
