...
define( "_AM_XTUBE_WARNINSTALL3", "WAARSCHUWING: Map %s bestaat niet op uw server. <br />Deze map is nodig voor MyTube." );
...
define( "_AM_XTUBE_VIDEO_SPHPINI", "<b>Informatie uit PHP.ini link:</b>" );
...
define( "_AM_XTUBE_VIDEO_GDON", "<b>ingeschakeld</b> (thumbsnails beschikbaar)" );
define( "_AM_XTUBE_VIDEO_GDOFF", "<b>uitgeschakeld</b> (thumbnails niet beschikbaar)" );
define( "_AM_XTUBE_VIDEO_OFF", "<b>uit</b>" );
define( "_AM_XTUBE_VIDEO_ON", "<b>aan</b>" );
...
define( "_AM_XTUBE_MINDEX_PAGE", "<b>Pagina:<b> " );
define( '_AM_XTUBE_MINDEX_PAGEINFOTXT', '<ul><li>MyTube Hoofdpagina details.</li><li>U kunt eenvoudig veranderingen aanbrengen aan het logo, de afbeelding, de kop en voetteksten om de pagina aan uw wensen te laten voldoen.</li></ul><br />Opmerking: Het gekozen logo wordt door de gehele MyTube module toegepast.' );
...
define( "_AM_XTUBE_SUB_APPROVEWAITINGFILE", "Nieuwe videos informatie <b>accepteren zonder goedkeuring</b>." );
define( "_AM_XTUBE_SUB_EDITWAITINGFILE", "<b>Wijzig</b> nieuwe video informatie en keur daarna goed." );
define( "_AM_XTUBE_SUB_DELETEWAITINGFILE", "<b>Verwijder</b> nieuwe video informatie." );
...
define( "_AM_XTUBE_VOTE_DELETEDSC", "<b>Verwijderd</b> de gekozen stem informatie uit de database." );
...
define( "_AM_XTUBE_VIDEO_IP", "IP adres van uploader: " );
define( "_AM_XTUBE_VIDEO_ALLOWEDAMIME", "<div style='padding-top: 4px; padding-bottom: 4px;'><b>Toegestane beheerder video formaten</b>:</div>" );
...
define( "_AM_XTUBE_VIDEO_PICURLNOTE", "<small>Afbeeldings url als de bron Google Video, MySpace TV, DailyMotion, Blip.tv, ClipFish, LiveLeak, Veoh, Vimeo, Megavideo, Viddler of Maktoob is.</small>" );
...
define( "_AM_XTUBE_VIDEO_SETASUPDATED", " Video status weergeven als bijgewerkt?<br /><br /><small><span style='font-weight: normal;'>Video zal een 'bijgewerkt' icoon weergeven.</span></small>" );
...
define( "_AM_XTUBE_VIDEO_SETPUBLISHDATE", "<b>Stel publikatiedatum in: </b>" );
define( "_AM_XTUBE_VIDEO_SETNEWPUBLISHDATE", "<b>Stel nieuwe publikatiedatum in: </b><br />Gepubliceerd op:" );
define( "_AM_XTUBE_VIDEO_SETPUBDATESETS", "<b>Stel publikatiedatum in: </b><br />Gepubliceerd op:" );
define( "_AM_XTUBE_VIDEO_EXPIREDATESET", " Stel verloopdatum in: " );
define( "_AM_XTUBE_VIDEO_SETEXPIREDATE", "<b>Stel verloopdatum in: </b>" );
define( "_AM_XTUBE_VIDEO_DELEDITMESS", "Verwijder gebroken video rapport?<br /><br /><span style='font-weight: normal;'>Kies <b>Ja</b> en het gebroken video rapport wordt automatisch verwijderd tevens wordt bevestigd dat de video weer werkt.</span>" );
...
define( "_AM_XTUBE_VIDEO_CREATENEWSSTORY", "<b>Maak een nieuwsbericht van de video</b>" );
...
define( "_AM_XTUBE_BROKEN_IGNOREDESC", "<b>Negeert</b> het rapport en verwijderd allen de gebroken video rapportage." );
define( "_AM_XTUBE_BROKEN_DELETEDESC", "<b>Verwijdert</b> de gerapporteerde videodata en gebroken video rapportage van de video." );
define( "_AM_XTUBE_BROKEN_EDITDESC", "de video <b>Aanpassen</b> om het probleem te verhelpen." );
define( "_AM_XTUBE_BROKEN_ACKDESC", "<b>Toegekend</b> Stelt de toegekende status van de gebroken bestandsrapportage in." );
define( "_AM_XTUBE_BROKEN_CONFIRMDESC", "<b>Bevestigd</b> Stelt de status van de gebroken videorapportage in als bevestigd." );
...
define( "_AM_XTUBE_KEYWORDS_NOTE", "<small>Keywords dienen gescheiden te worden door een komma (<i>keyword1, keyword2, keyword3</i>).</small>" );
...
define( "_AM_XTUBE_MMYTUBE", "MyTube Clip" );
...
define( "_AM_XTUBE_MYTUBEVIDEO", "MyTube Video Bestand:" );
define( "_AM_WFL_WARNINSTALL4", "<b>WAARSCHUWING:</b> <u>Map</u> %s is niet beschrijfbaar. <br />Deze map dient schrijfbaar (CHMOD 777) te zijn voor MyTube." );
// Uploader class
