...
define( "_AM_XTUBE_MMYTUBE", "Añadir MyTube Clip" );
define( "_AM_XTUBE_VIDEO_CATVIDEOIMG", "Imágenes del video" );
define( "_AM_XTUBE_VIDEO_FCATVIDEOIMG", "Ruta a las imágenes del video" );
define( "_AM_XTUBE_VUPLOAD_VIDEOEXIST", "El video ya existe" );
define( "_AM_XTUBE_VUPLOAD_VIDEOUPLOAD", "Video subido" );
define( "_AM_XTUBE_VUPLOAD_NOVIDEOEXIST", "No existe el video" );
...
define( "_AM_XTUBE_VUPLOAD_DELETEFILE", "Eliminar el archivo del video" );
define( "_AM_XTUBE_VUPLOAD_CATVIDEO", "Archivos de video" );
define( "_AM_XTUBE_VUPLOAD_FCATVIDEO", "Directorio de subida de videos" );
define( "_AM_XTUBE_VUPLOADS", "Subir video " );//Video Upload
define( "_AM_XTUBE_VUPLOAD_FUPLOADPATH", "Ruta para subir el video:" );
define( "_AM_XTUBE_VUPLOAD_FUPLOADURL", "URL para subir el video:" );
define( "_AM_XTUBE_VUPLOAD_FUPLOADVIDEOTO", "Subir video: " );
...
define( "_AM_XTUBE_VUPLOAD_FSHOWSELECTEDFILE", "Seleccionar un archivo de video" );
define( "_AM_XTUBE_VUPLOAD_FSHOWSELECTEDFILEDSC", "El archivo de video debe ser del tipo FLV" );
define( "_AM_XTUBE_BDELETEVIDEO", "Eliminar video" );
define( "_AM_XTUBE_NOVIDEO", "No mostrar video" );
...
define( "_AM_XTUBE_MYTUBEVIDEO", "Archivo de video de MyTube:" );
define( "_AM_WFL_WARNINSTALL4", "<b>Advertencia:</b> <u>La carpeta</u> %s no tiene permisos de escritura. <br />La misma necesita que el servidor pueda escribir en ella (CHMOD 777) para el uso de MyTube." );
// Uploader class
