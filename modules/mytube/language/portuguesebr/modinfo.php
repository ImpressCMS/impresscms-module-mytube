...
define('_MI_XTUBE_DATEFORMATADMINDSC', 'Admininstração padrão Timestamp para o MyTube');

// Version 1.04 RC-1
define('_MI_XTUBE_VIDEODIR', 'Diretório para Upload de Videos:');
define('_MI_XTUBE_VIDEODIRDSC', 'Defina o diretório para os arquivos de Video do MyTube');
