...
define( "_MD_XTUBE_THEREARE", "Há <b>%s</b> <i>Categorias</i> e <b>%s</b> <i>Vídeos</i> listados" );
...
define( "_MD_XTUBE_VIDEO_PICURLNOTE", "Url da Foto quando for um código do Google Video, MySpace TV, DailyMotion, Blip.tv, ClipFish, Maktoob, Veoh, Vimeo ou LiveLeak" );
...
define( '_MD_XTUBE_STOPIT', 'PARE DE ENGANAR!!' ); //não tenho certeza para traduzir - GibaPhp
