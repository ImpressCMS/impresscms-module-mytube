...
define( "_AM_XTUBE_VIDEO_PICURLNOTE", "<small>Bilder URL wenn das Video von Google Video, MySpace TV, ClipFish, Blip.tv, LiveLeak oder DailyMotion ist.</small>" );
...
define( "_AM_XTUBE_VUPLOAD_FILEDELETED", "Video gel&ouml;scht" );
define( "_AM_XTUBE_VUPLOAD_FILEERRORDELETE", "Fehler" );
define( "_AM_XTUBE_VUPLOAD_NOFILEERROR", "Keine Datei" );
define( "_AM_XTUBE_VUPLOAD_DELETEFILE", "L&ouml;sche Video Datei" );
...
define( "_AM_XTUBE_VUPLOAD_FOLDERSELECTION", "Zielordner zum hochladen ausw&auml;hlen" );
define( "_AM_XTUBE_VUPLOAD_FUPLOADVIDEO", "Video zum upload" );
define( "_AM_XTUBE_VUPLOAD_FSHOWSELECTEDFILE", "W&auml;hle eine Videodatei" );
define( "_AM_XTUBE_VUPLOAD_FSHOWSELECTEDFILEDSC", "Videodatei muss vom Type FLV sein" );
define( "_AM_XTUBE_BDELETEVIDEO", "L&ouml;sche Video" );
define( "_AM_XTUBE_NOVIDEO", "Zeige kein Video" );
define( "_AM_XTUBE_NOIMAGE", "Zeige kein Bild" );
define( "_AM_XTUBE_NOSELECT", "Keine Auswahl" );
define( "_AM_XTUBE_NOFILESELECT", "Keine Datei ausgew&auml;hlt" );
define( "_AM_XTUBE_MYTUBEVIDEO", "MyTube Video Datei:" );
define( "_AM_XTUBE_WARNINSTALL4", "<b>Achtung:</b> <u>Ordner</u> %s ist nicht beschreibbar. <br />Der Ordner braucht die Berechtigungen (CHMOD 777) f&uuml;r MyTube." );
define( "_AM_XTUBE_CATSPONSOR", "W&auml;hle Klient:" );
define( "_AM_XTUBE_CATSPONSORDSC", "Wird ein Kient ausgew&auml;hlt so werden alle zugeordneten Banner im Wechsel angezeigt,<br /> somit ist die Auswahl eines Banners im n&auml;chsten Feld nicht n&ouml;tig und wird ggf. nicht gespeichert." );
define( "_AM_XTUBE_BANNER", "Banner" );
define( "_AM_XTUBE_FBANNER", "Banner" );
define( "_AM_XTUBE_BANNERID", "W&auml;hle Banner ID:" );
define( "_AM_XTUBE_BANNERIDDSC", "Wenn oben ein Klient gew&auml;hlt wurde wird die Banner ID nicht gespeichert!" );
// Uploader class
define( "_AM_XTUBE_READWRITEERROR", "Es wurde keine Datei zum Upload ausgew&auml;hlt oder der Server hat Lese/Schreibporbleme mit dieser Datei!" );
define( "_AM_XTUBE_INVALIDFILESIZE", "Falsche Dateigr&ouml;&szuml;e" );
...
define( "_AM_XTUBE_UPLOADERRORFOUR", "Keine Datei zum Upload gew&auml;hlt. Fehler: 4" );
define( "_AM_XTUBE_UPLOADERRORFIVE", "Keine Datei zum Upload gew&auml;hlt. Fehler: 5" );
define( "_AM_XTUBE_NOUPLOADDIR", "Uploadordner wurde nicht gew&auml;hlt" );
define( "_AM_XTUBE_FAILOPENDIR", "Fehler beim &ouml;ffnen der Ordners: " );
define( "_AM_XTUBE_FAILOPENDIRWRITEPERM", "Ordner konnte aufgrund fehlerhafter Berechtigung nicht ge&ouml;ffnet werden: " );
define( "_AM_XTUBE_FILESIZEMAXSIZE", "Dateigr&ouml;&szuml;e: %u. Maximal erlaubte Gr&ouml;&szuml;e: %u" );
define( "_AM_XTUBE_FILESIZEMAXWIDTH", "Videobreite: %u. Maximal erlaubte Breite: %u" );
define( "_AM_XTUBE_FILESIZEMAXHEIGHT", "Videoh&ouml;he: %u. Maximal erlaubte H&ouml;he: %u" );
