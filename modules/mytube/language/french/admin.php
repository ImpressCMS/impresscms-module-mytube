...
define( "_AM_XTUBE_BLOCKADMIN", "Paramètres des blocs" );
...
define( "_AM_XTUBE_FCATEGORY_SUBGROUPPROMPT", "Permissions de soummetre:<div style='padding-top: 8px;'><span style='font-weight: normal;'>Sélectionner le(s) groupe(s) d'utilisateurs qui aur(ont)a la possibilité de soummetre des vidéos.</span></div>" );
 ...
 */
define( "_AM_XTUBE_VIDEO_IMAGEUPLOAD", "Image uploadée sur le serveur avec succès" );
define( "_AM_XTUBE_VIDEO_NOIMAGEEXIST", "ERREUR: Aucune image sélectionnée pour l'upload. Essayez à nouveau!" );
...
define( "_AM_XTUBE_VIDEO_MAXUPLOADSIZE", "Taille maximum d'upload autorisée: " );
define( "_AM_XTUBE_VIDEO_MAXPOSTSIZE", "Taille maximum d'envoi autorisée: " );
...
define( "_AM_XTUBE_VIDEO_FOLDERSELECTION", "Sélectionner la destination de l'upload:" );
define( "_AM_XTUBE_VIDEO_FSHOWSELECTEDIMAGE", "Afficher l'image sélectionnée:" );
define( "_AM_XTUBE_VIDEO_FUPLOADIMAGE", "Uploader une nouvelle image pour la destination sélectionnée:" );
...
define( '_AM_XTUBE_MINDEX_PAGEINFOTXT', "<ul><li>Accueil MyTube.</li><li>Vous pouvez facilement modifier le logo, les textes de l'entête et du pied de page, de l'index afin d'avoir un look plus aproprié</li></ul><br /><br />Note: Le logo choisie sera utilisé pour toutes les pages du module." );
...
define( "_AM_XTUBE_MOD_SHOTIMAGE", "Capture d'écran: " );
...
define( "_AM_XTUBE_VIDEO_PICURLNOTE", "<small>Url de l'image quand Google Video, MySpace TV, LiveLeak, Blip.tv, ClipFish, Maktoob ou DailyMotion est la Source.</small>" );
...
define( "_AM_XTUBE_VIDEO_CREATENEWSSTORY", "<b>Soumettre la vidéo comme news?</b>" );
define( "_AM_XTUBE_VIDEO_SUBMITNEWS", "Soummetre la vidéo comme un article dans les News?" );
define( "_AM_XTUBE_VIDEO_NEWSCATEGORY", "Selectonner la catégorie de News pour soumettre:" );
define( "_AM_XTUBE_VIDEO_NEWSTITLE", "Titre de la News:<div style='padding-top: 4px; padding-bottom: 4px;'><span style='font-weight: normal;'>Laisser le champs vide pour utiliser le nom de la Vidéo comme titre</span></div>" );
...
define( "_AM_XTUBE_BROKEN_FILEIGNORED", "Rapport de vidéo brisée ignoré et base de donnée mise à juour avec succés!" );
...
define( "_AM_XTUBE_BROKEN_EDITDESC", "<b>Editer</b> la vidéo pour corriger le problème." );
...
define( "_AM_XTUBE_BROKENFILEDELETED", "Vidéo retirée de la base de donnée et le rapport a été effacé" );
...
define( "_AM_XTUBE_ICO_VIDEO", "URL vidéo Relatif" );
...
define( "_AM_XTUBE_RES_INFOTEXT", "<ul><li>De nouvelles ressources peuvent-être ajoutées, modifées ou effacées facilement via ce formulaire.</li>
...
define( "_AM_XTUBE_NO_FORUM", "Aucun forum sélectionnée" );

define( "_AM_XTUBE_PERM_RATEPERMISSIONS", "Permissions d'estimer" );
define( "_AM_XTUBE_PERM_RATEPERMISSIONS_TEXT", "Sélectionner les groupes qui peuvent estimer des vidéos pour les catégories affichées." );

define( "_AM_XTUBE_PERM_AUTOPERMISSIONS", "Permissions d'approuver" );
define( "_AM_XTUBE_PERM_AUTOPERMISSIONS_TEXT", "Sélectionnez les groupes qui, leurs vidéos seront automatiquement approuvées sans l'intervention de l'administrateur." );
...
define("_AM_XTUBE_VIDEO_META_DESCRIPTION_DSC", "Dans le cadre d'améliorer votre réferencement, vous pouvez utiliser des meta descriptions signitifs pour cette vidéo. Si vous laissez ce champ vide en créant une catégorie, Il deviendra automatiquement populaire avec le champs récapitulatif de cette vidéo.");
