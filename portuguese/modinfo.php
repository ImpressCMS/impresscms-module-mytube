...
define("_MI_MYTUBE_INDEXPAGE","Gerenciamento da Página Inicial");
define("_MI_MYTUBE_MCATEGORY","Gerenciamento das Categorias");
define("_MI_MYTUBE_MVIDEOS","Gerenciamento dos Vídeos");
define("_MI_MYTUBE_MUPLOADS","Upload de Imagem");
define("_MI_MYTUBE_PERMISSIONS","Ajuste das Permissões");
define("_MI_MYTUBE_BLOCKADMIN","Ajuste dos Blocos");
define("_MI_MYTUBE_MVOTEDATA","Votos");

// Title of config items
define("_MI_MYTUBE_POPULAR", "Contagem como vídeo popular");
define("_MI_MYTUBE_POPULARDSC", "O número de exibições para que o vídeo seja considerado popular.");
...
define("_MI_MYTUBE_EDITORCHOICE", "Selecione o editor para usar. Se você tem uma instalação 'simples' (i.e. se você usa somente o editor que vem com o núcleo do pacote padrão), então você somente poderá selecionar DHTML e Compacto");
define('_MI_MYTUBE_EDITORUSER', "Editor para uso (usuário):");
define('_MI_MYTUBE_EDITORCHOICEUSER', "Selecione o editor a ser usado para o lado do usuário. Se você tem uma instalação 'simples' (por exemplo, você usa apenas a classe do núcleo de editores, isto é o padrão de editores no pacote.), então você pode selecionar apenas DHTML e compacto.");
...
define("_MI_MYTUBE_USERTAGDSC", "Selecione Sim se o usuário está autorizado a enviar tags.");
