...
// Video source
    $vidsource_array = array( 0 => _AM_XTUBE_YOUTUBE,
                              ...
                              105 => _AM_XTUBE_LIVELEAK );  // #200 is reserved for MyTube's internal FLV player
...
// Video Expire Date
    ...
    $expiredates = ( $expired > time() ) ? _AM_XTUBE_VIDEO_EXPIREDATESET . formatTimestamp( $expired, $xoopsModuleConfig['dateformat'] ) : _AM_XTUBE_VIDEO_SETDATETIMEEXPIRE;
